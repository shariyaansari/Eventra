  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-blue-100 flex flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      ...
      <motion.div
        ...
        className="w-full max-w-4xl bg-white shadow-xl rounded-2xl p-8 border border-indigo-300 mb-10"
      >
      ...
      >
        {[
          ...
          <motion.div
            key={index}
            whileHover={{ scale: 1.05 }}
            className="bg-white border border-indigo-300 rounded-2xl shadow-xl p-6 text-center flex flex-col items-center"
          >
